...
![](../assets/webpack_tree-shaking-1.png)
...
![](../assets/webpack_tree-shaking-2.png)


因此，在下面这种跨文件的场景下，UglifyJS 无法将没有用到的函数 `fn2` 消除。

![](../assets/webpack_tree-shaking-3.png)
...
![](../assets/webpack_tree-shaking-4.png)
...
![](../assets/webpack_tree-shaking-5.png)
